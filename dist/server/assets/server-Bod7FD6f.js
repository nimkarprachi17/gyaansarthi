...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-s4C1IhDL.js");
...
const manifest = {
  "140620bf5d58dd4abcbc154e6897ae01ed13993d7c12d4c6ecd786ca00015dea": {
    ...
    importer: () => import("./video.functions-CmANln-L.js")
  },
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ClNXf9dT.js").then((n) => n.r),
    import("./start-DpFNHI9R.js"),
