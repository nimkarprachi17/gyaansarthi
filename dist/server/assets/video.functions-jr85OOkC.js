import { T as TSS_SERVER_FUNCTION, a as createServerFn } from "./server-Bee8Jo-H.js";
import { z } from "zod";
import { r as requireSupabaseAuth } from "./auth-middleware-DJtYHvKR.js";
...
const processVideo = createServerFn({
  ...
  const {
    generateNotes,
    generateQuiz
  } = await import("./ai.server-B4fmZumt.js");
